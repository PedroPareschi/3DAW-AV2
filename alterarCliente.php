<?php
    ...
    $comandoSQL = "UPDATE `clientes` SET 'nome'='$nome','endereco'=$endereco','postalCode'=$postalCode', 'pais'='$pais', 'cpf'='$CPF', 'passaporte'='$passaporte', 'email'='$email', 'dataNascimento'='$dataNascimento')";
